import 'package:doctor/appointment/ReportIssue.dart';
import 'package:flutter/material.dart';

class AppointmentExpired extends StatelessWidget {
  const AppointmentExpired({Key? key}) : super(key: key);
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      const Text(
                        'Your check-in time has expired !',
                        textAlign: TextAlign.start,
                        style: TextStyle(
                          fontSize: 18,
                          color: Colors.black,

class searchdoctorby_speciality {
  Data? data;

  searchdoctorby_speciality({this.data});

  searchdoctorby_speciality.fromJson(Map<String, dynamic> json) {
...
class Doctors {
  ...
  dynamic ownershipId;
  dynamic ownershipDocument;
  String? about;
  String? phoneVerifiedAt;
  String? otpToken;
  String? emailVerifiedAt;
  dynamic emailOtpToken;
...
class Pivot {
  ...
  Pivot({this.specialityId, this.doctorId});
...
class Specialities {
  ...
  Specialities.fromJson(Map<String, dynamic> json) {
    ...
    createdAt = json['created_at'];
    updatedAt = json['updated_at'];
    pivotS = json['pivot'] != null ? PivotS.fromJson(json['pivot']) : null;
  }

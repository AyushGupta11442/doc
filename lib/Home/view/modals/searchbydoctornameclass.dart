class searheddoctorbyname {
  Data? data;

  searheddoctorbyname({this.data});

  searheddoctorbyname.fromJson(Map<String, dynamic> json) {
...
class Doctors {
  ...
  Doctors.fromJson(Map<String, dynamic> json) {
    ...
    clinicDetailsCount = json['clinic_details_count'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['clinic_details_count'] = clinicDetailsCount;

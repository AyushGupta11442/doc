...
import 'package:doctor/Home/view/modals/searchbydoctornameclass.dart';
...
class Searchbyspecialistname extends ConsumerStatefulWidget {
  const Searchbyspecialistname({Key? key, required this.name})
      : super(key: key);
  final String name;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SearchbyspecialistnameState();
}

class _SearchbyspecialistnameState
    extends ConsumerState<Searchbyspecialistname> {
  late searheddoctorbyname doctorList;
  bool isload = false;
  String name = '';
  ...
  void getDoctors() async {
    try {
      final response = await DioClinetToken.instance.dio!
          .post('/doctor_search', data: {'name': widget.name});
        ...
        body: (isload)
            ? SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    for (Doctors d in doctorList.data!.doctors!)
                      doctordetail(
                        d,
                      ),
                  ],
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          'Experience : ${(d.experience == null) ? 'No Given' : d.experience} Years',
                          textAlign: TextAlign.start,
                          style: const TextStyle(
                            fontFamily: 'Poppins SemiBold',
                            fontSize: 12.0,
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          'Rs. ${(d.clinic?.fees == null) ? 'Unknown' : d.clinic?.fees}',
                          textAlign: TextAlign.start,
                          style: const TextStyle(
                              fontFamily: 'Poppins SemiBold',
                              fontSize: 14.0,
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          Text(
                            '${(d.nextSlot?.time == null) ? 'Not available' : d.nextSlot?.time}',
                            overflow: TextOverflow.ellipsis,
                            textAlign: TextAlign.start,
                            style: const TextStyle(
                              fontFamily: 'Poppins SemiBold',
